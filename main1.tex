...
% \includepdf[pages=-,pagecommand={},width=1.3\textwidth]{Exhibits/Citation reports.pdf}
...
\includepdf[pages={1,2,3,17,18},pagecommand={},width=1.3\textwidth]{Exhibits/12 Leading Chinese Companies in the AI Large Model Sector.pdf}
